...
class VQA_DataLoader():
    ...
    IMAGES_PATH = r"C:\Users\Computing\Downloads\vaq2.0.dataset-cmp9137-item1\val2014-resised"
    ...
    def evaluate(self, dataloader):
        ...
        with torch.no_grad():
            ...
            for batch in dataloader:
                ...
                outputs = self.classifier_model(images, questions)
                ...
                true_positives = ((predicted == 1) & (answers == 1)).sum().item()
                false_positives = ((predicted == 1) & (answers == 0)).sum().item()
                false_negatives = ((predicted == 0) & (answers == 1)).sum().item()
